...
- **Cources:** 
_RS Schools Course «JavaScript/Front-end. Stage 0» ([certificate][https://app.rs.school/certificate/40rf6vq6])_
_RS Schools Course «JavaScript/Front-end. Stage 1» (now)_
- **Languages:**
  - _English - A2_
  - _Russian - Native_